<div id="avisos-destacados-movil" class="small-12 columns hide-for-large p0 minH_100vh">
  ...
  <a href="#">
    <div id="avisos-destacados-header" class="small-9 columns p2 m0 h_10vh fontRM text-left">
      <div class="vcenter">
        Avisos Destacados
      </div>
    </div>
    <div id="avisos-destacados-header" class="small-3 columns p2 m0 h_10vh fontRL bold text-center">
      <div class="vcenter">
        <i class="fa fa-angle-right"></i>
      </div>
    </div>
  </a> <!-- temrina header destacados -->

  <a href="#">
    <div id="avisos-destacados-principal" class="large-12 columns p0 m0 h_50vh">

      <div id="avisos-destacados-principal-header" class="small-12 columns p3 m0 abs z1">
        ...
        <div id="avisos-destacados-principal-header-fecha" class="small-4 columns text-center pt1 fontRXS"> 1 January 1970</div>
      </div>
